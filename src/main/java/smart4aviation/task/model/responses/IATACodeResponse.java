...
public class IATACodeResponse {
    ...
    public IATACodeResponse(int allPiecesArriving, int numberOfFlightArriving, int allPiecesDeparturing, int numberOfFlightDeparturing, boolean isFailed, String failedReason) {
    ...
    public boolean equals(Object o) {
        ...
        IATACodeResponse that = (IATACodeResponse) o;
